...
class Utility:
    @staticmethod
    def create_track(name: str, content_types: Set[ContentType], mixer_role: MixerRole, volume: float,
                     pan: float) -> Track:
    ...
    @staticmethod
    def create_audio(relative_path: str, sample_rate: int, channels: int, duration: float) -> Audio:
        audio = Audio(
